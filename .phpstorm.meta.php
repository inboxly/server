    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'Inboxly\Receiver\Managers\ExplorerManager' => \Inboxly\Receiver\Managers\ExplorerManager::class,
            'Inboxly\Receiver\Managers\FetcherManager' => \Inboxly\Receiver\Managers\FetcherManager::class,
            'Inboxly\Receiver\Sources\Common\CommonCorrector' => \Inboxly\Receiver\Sources\Common\CommonCorrector::class,
            'Inboxly\Receiver\Sources\Reddit\RedditRssExplorer' => \Inboxly\Receiver\Sources\Reddit\RedditRssExplorer::class,
            'Inboxly\Receiver\Sources\Reddit\RedditRssFetcher' => \Inboxly\Receiver\Sources\Reddit\RedditRssFetcher::class,
            'Inboxly\Receiver\Sources\Reddit\RedditUserRssExplorer' => \Inboxly\Receiver\Sources\Reddit\RedditUserRssExplorer::class,
            'Inboxly\Receiver\Sources\Rss\RssCorrector' => \Inboxly\Receiver\Sources\Rss\RssCorrector::class,
            'Inboxly\Receiver\Sources\Rss\RssExplorer' => \Inboxly\Receiver\Sources\Rss\RssExplorer::class,
            'Inboxly\Receiver\Sources\Rss\RssFetcher' => \Inboxly\Receiver\Sources\Rss\RssFetcher::class,
            'Inboxly\Receiver\Sources\Youtube\YoutubeRssExplorer' => \Inboxly\Receiver\Sources\Youtube\YoutubeRssExplorer::class,
            'Inboxly\Receiver\Sources\Youtube\YoutubeRssFetcher' => \Inboxly\Receiver\Sources\Youtube\YoutubeRssFetcher::class,
            'Inboxly\TextProcessing\Handlers\Limit' => \Inboxly\TextProcessing\Handlers\Limit::class,
            'Inboxly\TextProcessing\Handlers\RemoveHtml' => \Inboxly\TextProcessing\Handlers\RemoveHtml::class,
            'Inboxly\TextProcessing\Handlers\SanitizeHtml' => \Inboxly\TextProcessing\Handlers\SanitizeHtml::class,
            'Inboxly\TextProcessing\Handlers\Trim' => \Inboxly\TextProcessing\Handlers\Trim::class,
            'Inboxly\TextProcessing\Processor' => \Inboxly\TextProcessing\Processor::class,
            'NunoMaduro\Collision\Contracts\Provider' => \NunoMaduro\Collision\Provider::class,
            'Whoops\Handler\HandlerInterface' => \Facade\Ignition\ErrorPage\IgnitionWhoopsHandler::class,
            'auth' => \Illuminate\Auth\AuthManager::class,
            'auth.driver' => \Illuminate\Auth\TokenGuard::class,
